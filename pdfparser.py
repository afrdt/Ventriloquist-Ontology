...
def parse_args(defaults):
    ...
    parser = argparse.ArgumentParser(description="Extracts sentences containing keywords from pdfs. Output will be saved in output directory as text file with the following name -> [first keyword][current time].txt.")
